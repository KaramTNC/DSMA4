...
const file_proto_proto_rawDesc = "" +
	...
	"\vTimeMessage\x12*\n" +
	"\x10lamportTimestamp\x18\x01 \x01(\x05R\x10lamportTimestamp29\n" +
	"\n" +
	"UserServer\x12+\n" +
	"\x0fMessageToServer\x12\b.Message\x1a\f.TimeMessage\"\x00B\x12Z\x10DSMA4/grpc/protob\x06proto3"
...
var file_proto_proto_depIdxs = []int32{
	0, // 0: UserServer.MessageToServer:input_type -> Message
	1, // 1: UserServer.MessageToServer:output_type -> TimeMessage
